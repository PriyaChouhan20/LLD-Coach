...
import { EvaluationResult, EvaluationResult as IEvalResult } from '../../domain/models/EvaluationResult.js';
...
export class AIEvaluator implements IEvaluator {
  public readonly name = 'AIEvaluator';
  ...
  private parseAndValidateResponse(rawJson: string): any {
    try {
